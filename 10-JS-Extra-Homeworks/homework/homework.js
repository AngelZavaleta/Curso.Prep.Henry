...
function capicua(numero){
  ...
  //Escribe tu código aquí
  let num = numero.toString(); //540 / 540 
  let numInvertido = num.split('').reverse().join('');// 045
...
function sortArray(arr) {
  ...
  while (cambio) {
    cambio = false;
    for (let i = 0; i <arr.length-1; i++) { //you, are, beatiful, looking
...
function buscoInterseccion(arreglo1, arreglo2){
  ...
  //Escribe tu código aquí   // [2,3,4,5,6] [5,7,9,1,2]
  let elementos = []; 
